...
const faqCategories = [
  {
    ...
    description: "Learn the basics of Synapse International and SRN platform",
    icon: BookOpen,
    faqs: [
      {
        question: "What is SRN / Synapse?",
        answer: "SRN (Synapse Recruiter Network), also known simply as Synapse, is part of Synapse International — a Global AI-First Recruitment Platform built with an extensive worldwide network of professional recruiters. We combine the power of AI with the human touch to deliver faster, higher-quality hiring solutions for startups and growing companies across the world."
      },
      {
        question: "What makes Synapse International different from other recruitment agencies?",
        answer: "We're an AI-first recruitment platform that focuses exclusively on the top 1% of talent. Unlike traditional agencies, we don't post job boards or chase volume. Our DNA is built around identifying exceptional professionals who aren't actively job hunting but are open to extraordinary opportunities."
      },
      {
  ...
  },
  {
    ...
    description: "Everything you need to know about hiring through Synapse",
    icon: Briefcase,
    faqs: [
      {
      ...
      },
      {
        ...
        answer: "While our focus is on quality over quantity, our AI platform can efficiently scale for projects requiring multiple top-tier hires. We've successfully managed projects requiring dozens of exceptional placements while maintaining our high standards."
      },
      {
  ...
  {
    id: "srn-network",
    title: "SRN (Synapse Recruiter Network)",
    description: "Information for recruiters joining our network",
    icon: Users,
    faqs: [
      {
  ...
  },
  {
    ...
    description: "Legal, confidentiality, and compliance information",
    icon: Shield,
    faqs: [
      {
  ...
  },
  {
    ...
    description: "Get help with common issues and technical problems",
    icon: Settings,
    faqs: [
      {
      ...
      <section className="pt-32 pb-16 bg-gradient-to-br from-synapse-primary via-synapse-secondary to-synapse-tertiary relative overflow-hidden">
        ...
        <div className="container-wide text-center relative">
          ...
          <p className="text-xl text-white/90 max-w-3xl mx-auto mb-8">
            Find answers and support for Synapse International's AI-powered recruitment platform
          </p>
