            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-synapse-gray mb-6">
                  Our Outreach Agent analyzes candidate profiles, career trajectories, and interests to craft uniquely personalized messages that resonate. With advanced natural language processing, every outreach feels authentic and relevant, dramatically improving engagement rates.
                </p>
