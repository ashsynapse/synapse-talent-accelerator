...
import { ArrowRight, Search, Target, Users, Zap, Database, CheckCircle, Settings, Activity, Brain, TrendingUp, Shield, Lightbulb, Clock } from "lucide-react";
...
const SourcingAgent = () => {
  ...
  return (
    <PageTemplate 
      ...
      description="AI-powered candidate discovery and talent acquisition automation"
    >
      {/* Hero Section */}
