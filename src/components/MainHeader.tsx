...
const MainHeader = () => {
  ...
  const navItems = [
    ...
    { 
      ...
      submenu: [
        { label: "Sourcing Agent", href: "/tools/ai-sourcing-agent" },
        { label: "Outreach Agent", href: "/tools/ai-outreach-agent" },
        { label: "Submission Agent", href: "/tools/ai-submission-agent" },
